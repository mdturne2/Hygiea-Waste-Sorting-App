"""
Django settings for hywz project.
...
#Dir where any media will be uploaded to
...
SECRET_KEY = '-73r$&r1z^r=c6#epe6#hv)5ke(#@3a1z%pfkpvq4qmvs4k407'
...
WSGI_APPLICATION = 'hywz.wsgi.application'
